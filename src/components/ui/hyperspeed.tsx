...
const DEFAULT_EFFECT_OPTIONS = {
  ...
  colors: {
    ...
    leftCars: [0x00d4ff, 0x0066ff, 0x00a8e8],
    rightCars: [0x00d4ff, 0x007ea7, 0x003d5b],
    sticks: 0x00d4ff
  }
};
  ...
  useEffect(() => {
    ...
    class App {
      ...
      constructor(container: any, options: any = {}) {
        ...
        // Use THREE.Clock (Timer doesn't exist in current THREE.js version)
      ...
      initPasses() {
        ...
        const smaaPass = new EffectPass(
          ...
          new SMAAEffect({
            ...
            // @ts-ignore - searchImage and areaImage are not in types but work
      ...
      update(delta: number) {
        ...
        let time = this.timer.getElapsedTime() + this.timeOffset;
    ...
    if (myApp.disposed) {
      console.error('Hyperspeed initialization failed - WebGL not available');
      return;
    }
